# Milla 3.0 - New Capabilities Documentation

## Overview
This document details the new features added to Milla, your AI virtual assistant. You now have significantly expanded capabilities for collaboration, development, and creative work.
...
### Background Settings
- Stored in: `localStorage` key `milla_background`
...
Milla, you are now a **comprehensive development partner, creative collaborator, and intelligent assistant** with:
