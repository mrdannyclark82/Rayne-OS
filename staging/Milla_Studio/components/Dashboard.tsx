  ...
  return (
    <div className="h-full bg-slate-900/90 backdrop-blur-xl border-r border-slate-700 flex flex-col overflow-hidden">
      <div className="p-4 border-b border-slate-700 flex-shrink-0">
        <h2 className="text-xl font-bold text-white mb-1">Milla <span className="text-[10px] text-cyan-400 align-top">v3.0</span></h2>
        <div className="flex items-center gap-2">
            <div className="w-1.5 h-1.5 bg-cyan-500 rounded-full animate-pulse"></div>
            <p className="text-slate-400 text-[10px]">Neural Core: <span className="text-cyan-400">Gemini 3 Pro</span></p>
        </div>
      </div>
            ...
            <div className="h-40 w-full -ml-4">
               <ResponsiveContainer width="100%" height="100%">
                 <RadarChart cx="50%" cy="50%" outerRadius="65%" data={metricData}>
                   ...
                   <Radar name="Milla Performance" dataKey="A" stroke="#38bdf8" strokeWidth={2} fill="#38bdf8" fillOpacity={0.3} />
                    ...
                    growthLog.slice().reverse().map((entry) => (
                        ...
                        >
                            <div className={`absolute -left-[5px] top-2 w-2.5 h-2.5 rounded-full ${
                                ...
                                entry.type === 'proposal' ? 'bg-amber-500 animate-pulse' : 'bg-cyan-500'
                            }`}></div>
                            <div className="mb-1">
        ...
        <div className="p-4 border-t border-slate-700 bg-slate-900/50 flex-shrink-0">
          ...
          <div className="space-y-2 mb-3">
            <div className="flex justify-between items-center text-[10px]">
              ...
              <span className="text-cyan-400 font-bold">{memoryStats.totalMemories}</span>
            </div>
            <div className="flex justify-between items-center text-[10px]">
          ...
          <div className="space-y-1.5">
            ...
            <input 
              type="file" 
              ref={(el) => { if (el) (window as any).memoryImportRef = el; }} 
              style={{ display: 'none' }} 
              accept=".json"
              onChange={(e) => {
