# GEMINI.md - Milla AI Virtual Assistant

## Project Overview

This project is a sophisticated AI virtual assistant named "Milla". It's a web-based application built with React, TypeScript, and Vite. The UI is modern and feature-rich, including a 3D avatar, a dashboard for monitoring AI metrics, and a chat interface that supports various "tools".

Milla interacts with the Google Gemini API to provide its core functionality, which includes:
